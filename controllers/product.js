// used for file upload/image upload
...
exports.create = (req, res) => {
  // we need to send an image
  // we can't get everything by req.body because of image
  // all the form data are in form
  let form = new formidable.IncomingForm();
  // we need to keep extensions for everything whatever received
